...
public class Equip_Armor extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.equip_armor, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        arrlistItem.clear();
        mDBHelper.LoadEquip(database, name, "armor", arrlistItem);

        listAdapter = new MultipleListAdapter(getActivity().getApplicationContext(), arrlistItem, "armor", false);
